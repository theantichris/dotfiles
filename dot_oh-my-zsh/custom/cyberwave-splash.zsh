...
cyberwave_splash() {
    ...
    printf "    ${c_comment}│${c_reset}  ${c_warning}▣${c_reset} RAM:  %-14s ${c_secondary}%-20s${c_reset} ${c_comment}│${c_reset}\n" "${mem_info:0:14}" "${mem_bar}"
    printf "    ${c_comment}│${c_reset}  ${c_warning}▣${c_reset} Disk: %-14s ${c_tertiary}%-20s${c_reset} ${c_comment}│${c_reset}\n" "${disk_info:0:14}" "${disk_bar}"
    printf "    ${c_comment}│${c_reset}  ${c_warning}▣${c_reset} Net:  ${c_secondary}%-30s${c_reset}    ${c_comment}│${c_reset}\n" "${net_info}"
    echo "    ${c_comment}│${c_reset}                                     ${c_comment}│${c_reset}"
    echo "    ${c_comment}┴────${c_secondary}◉${c_comment}──┴──────┴────────┴──────┴──${c_secondary}◉${c_comment}────┴${c_reset}"
    echo "         ${c_primary}║${c_reset}                                 ${c_primary}║${c_reset}"
    echo "    ${c_primary}═════${c_comment}╬${c_primary}═══${c_tertiary}◈${c_primary}═══════════════════════${c_tertiary}◈${c_primary}═══${c_comment}╬${c_primary}═════${c_reset}"
