...
Style and structure reference for the `document` skill. Applies across all projects.
...
## CRUSH.md / AGENTS.md Standards

When updating agent context files:
...
- Follow the no-pronouns convention from `~/.config/crush/CRUSH.md`: write
  "Christopher" and "Agent" explicitly rather than "I" or "you". This overrides
  the second-person guidance below, which applies only to user-facing docs.
...
2. **Update all relevant files** - Usually README.md, SPEC.md, and CRUSH.md
...
- Use "you" for instructions (second person) in user-facing docs
...
- **New feature added**: Update README usage section, SPEC.md requirements, CRUSH.md commands
- **Dependency added**: Update README installation, CRUSH.md dependencies
- **Tool configured**: Update both README and CRUSH.md with commands
...
- **Architecture change**: Update SPEC.md technical design, CRUSH.md architecture section
