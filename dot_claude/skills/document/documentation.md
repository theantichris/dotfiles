...
- Follow the no-pronouns convention from `~/.claude/CLAUDE.md`: write
  "Christopher" and "Claude"/"Agent" explicitly rather than "I" or "you".
  This overrides the second-person guidance below, which applies only to
  user-facing docs.
