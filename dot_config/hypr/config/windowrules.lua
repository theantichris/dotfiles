...
hl.window_rule({ match = { class = "^(kitty-scratchpad)$" }, workspace = "special:terminal", stay_focused = true })
hl.window_rule({ match = { class = "^(kitty-btop)$" }, float = true, size = { "monitor_w*0.65", "monitor_h*0.72" } })

-- Opacity Overrides
local terminals = "^(kitty|kitty-scratchpad|kitty-btop|ghostty|[Kk]onsole|Alacritty|gnome-terminal|xfce[0-9]?-terminal)$"
