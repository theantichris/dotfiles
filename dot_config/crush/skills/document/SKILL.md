...
Style and structure rules live in [documentation.md](documentation.md) — read it before writing. It covers README, SPEC.md, CRUSH.md/AGENTS.md, and code-comment conventions.
...
2. **Update core documentation**
   ...
   - `CRUSH.md` / `AGENTS.md` — new commands, updated architecture notes
